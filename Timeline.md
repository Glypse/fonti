...
-   [x] If can't find font files in releases, in `fonts` folder, look for a font file in the repo without downloading the repo
-   [ ] Only download folder with correct file type
-   [x] Include where to find the font files in the registry
